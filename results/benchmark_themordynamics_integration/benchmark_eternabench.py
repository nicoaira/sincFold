...
def main():
    print("=" * 80)
    print("ETERNABENCH-CM BENCHMARK")
    print("=" * 80)
    print()
    ...
    # Load dataset
    print("Loading eternabench-cm train split...")
    ds = load_dataset("multimolecule/eternabench-cm")
    train = ds['train']
    print(f"Total sequences in train split: {len(train)}")
    print()

    # Convert to lists for processing
    sequences = train['sequence']
    structures = train['secondary_structure']
    ids = train['id']
    ...
    representative_indices = run_cdhit_filtering(
        ...
        output_prefix="/tmp/eternabench_cdhit"
    )
    print()
    ...
    output_file = 'benchmark_eternabench_results.csv'
